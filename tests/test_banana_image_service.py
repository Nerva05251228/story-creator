...
class ImagePlatformServiceCompatibilityTests(unittest.TestCase):
    ...
    def test_submit_and_status_urls_use_unified_platform(self):
        self.assertEqual(
            ...
            "https://ne.mocatter.cn/api/image/tasks",
        )
        self.assertEqual(
            image_service.get_image_status_api_url(task_id="task_123", model_name="banana-pro"),
            "https://ne.mocatter.cn/api/image/tasks/task_123",
        )
    ...
    def test_get_image_task_status_reads_unified_platform_response(self, mock_get_task):
        mock_get_task.return_value = {
            ...
            "resolution": "1K",
            "final_image_urls": [
                "https://ne.mocatter.cn/image/output/ComfyUI_00001.png",
            ],
        }
        ...
        self.assertEqual(
            result,
            {
                "status": "completed",
                "progress": 100,
                "images": ["https://ne.mocatter.cn/image/output/ComfyUI_00001.png"],
                "cost": 0.12,
                "provider": "momo",
                "model": "Nano Banana Pro",
                "resolution": "1K",
