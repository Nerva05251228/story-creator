...
_poll_storyboard2_sub_shot_video_status = storyboard2_video_polling.poll_storyboard2_sub_shot_video_status


_recover_storyboard2_video_polling = storyboard2_video_polling.recover_storyboard2_video_polling



_sync_storyboard2_processing_videos = storyboard2_video_polling.sync_storyboard2_processing_videos
...
async def generate_storyboard2_sub_shot_video(
    ...
    if _is_storyboard2_video_processing(initial_status):
        polling_thread = Thread(
            ...
            args=(sub_shot_video.id, task_id, debug_dir),
            kwargs={"save_debug_fn": _save_storyboard2_video_debug},
        )
