...
from env_config import get_int_env, load_app_env, mask_url
...
def _create_sqlite_engine():
    return create_engine(
        ...
        connect_args={
            ...
            "timeout": get_int_env("SQLITE_TIMEOUT_SECONDS", 60),
        },
        pool_pre_ping=True,
        pool_size=get_int_env("SQLITE_POOL_SIZE", 5),
        max_overflow=get_int_env("SQLITE_MAX_OVERFLOW", 5),
    )


def _create_postgresql_engine():
    connect_args = {}
    connect_timeout = get_int_env("DATABASE_CONNECT_TIMEOUT", 15)
    ...
    return create_engine(
        DATABASE_URL,
        pool_pre_ping=True,
        pool_size=get_int_env("DATABASE_POOL_SIZE", 10),
        max_overflow=get_int_env("DATABASE_MAX_OVERFLOW", 20),
        pool_recycle=get_int_env("DATABASE_POOL_RECYCLE_SECONDS", 1800),
