...
from env_config import get_env, get_first_env, load_app_env
from utils import upload_to_cdn

load_app_env()

# API配置
IMAGE_PLATFORM_USERNAME = get_env("IMAGE_PLATFORM_USERNAME", "story_creator")
IMAGE_PLATFORM_TASKS_URL = ""
BANANA_IMAGE_API_BASE_URL = ""
BANANA_IMAGE_API_TOKEN = get_first_env(
    "IMAGE_PLATFORM_API_TOKEN",
    "IMAGE_SERVICE_API_KEY",
    "BANANA_IMAGE_API_TOKEN",
    default="",
)
MOTI_STANDARD_IMAGE_API_BASE_URL = ""
